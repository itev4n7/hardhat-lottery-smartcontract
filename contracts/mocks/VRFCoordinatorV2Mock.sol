...
//     console.log("sc - address", address(this));
//     console.log("sc _requestId", _requestId, s_requests[_requestId].subId);
...
//     console.log("sc - address", address(this));
//     console.log("sc - _subId, requestId:", _subId, requestId);
//     s_requests[requestId] = Request({
//       subId: _subId,
//       callbackGasLimit: _callbackGasLimit,
//       numWords: _numWords
//     });
//     console.log("sc - s_requests.subId:", s_requests[requestId].subId);
...
//   function pendingRequestExists(uint64 /* _subId */) external pure returns (bool) {
//     revert("not implemented");
//   }
// }
